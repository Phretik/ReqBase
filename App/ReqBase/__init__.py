...
def create_app():
    ...
    app = Flask(__name__, static_url_path='', static_folder='/static', template_folder='C:\Users\talmond3\OneDrive - DXC Production\Documents\GitHub\ReqBase\App\ReqBase\templates')
